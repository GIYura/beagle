 ...
 */
int gpio_configure_dir(const char* const gpio_label, uint8_t dir_value)
{
    int fd;
    char buf[SOME_BYTES];
 ...
 */
int gpio_write_value(const char* const gpio_label, uint8_t out_value)
{
    int fd;
    char buf[SOME_BYTES];
 ...
 *  GPIO read value
 */
int gpio_read_value(const char* const gpio_label)
{
    int fd;
 ...
 */
int gpio_file_open(const char* const gpio_label)
{
    int fd;
    char buf[SOME_BYTES];
