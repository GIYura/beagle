...
{
    char label[20];             /* name of the gpio pin */
...
/*
struct platform_device descibed in /linux/platform_device.h
*/
...
int gpio_sysfs_probe(struct platform_device *pdev)
{
    ...
    /* macro for_each_available_child_of_node described in /linux/of.h 
    Find next available child of node.
    Iterate over device tree. Each iteration child variable will be filled with address of a child node. */
    for_each_available_child_of_node(parent, child)
    {
        ...
        /* described in /include/linux/gpio/consumer.h 
        ...
        Decribed in /linux/device.h 
        Create a device and registers it with sysfs. Also, create attributes: direction, value, label
        This function used instead of two:
        - device_create();
        - sys_create_file(); */
...
/*
described in /linux/mod_devicetable.h
used for mathing of a device
*/
...
/*
described in /linux/platform_device.h
of_match_ptr described in /linux/of.h
*/
struct platform_driver gpiosysfs_platform_driver = 
{
    ...
    .driver = {
           ...
           .of_match_table = of_match_ptr(gpio_device_match) /* device tree instantiation */
    }
};
...
{
    /* the order of functions call matters */
